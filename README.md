...
Run `cargo skyline new [name of plugin]`, for example `cargo skyline new momentum_transfer`. This should install the Rust standard library used by Skyline plugins if it is your first installation, so it may take a while.
